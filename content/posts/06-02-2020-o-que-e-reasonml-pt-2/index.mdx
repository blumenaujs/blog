...
- [Parte 2](https://blog.blumenaujs.org/o-que-e-e-por-que-utilizar-reasonml-parte-2)
...
as vantagens que Reason tem em relação a ele. Algumas coisas como pattern matching e varians, irei abordar de forma superficial. Porém, vou deixar
...
a biblioteca [fp-ts](https://github.com/gcanti/fp-ts). Mas já adianto que nenhuma lib ou implementação para TypeScript ou JavaScript, chegará a resultados tão benéficios como os que vimos acima.
