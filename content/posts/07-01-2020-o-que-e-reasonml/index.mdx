...
A primeira coisa que você deve ter se perguntado é: porquê usar _[||]_ ao invés de _[]_. E a resposta é simples, Reason diferente
de JavaScript possui uma estrutura de dados _Array_ e uma _List_, por hora, isso basta como justificativa. Falando da síntaxe
é bem simples comparar, como eu disse, mas quando se trata de manipular um array ( ou lista ), Reason trabalha de uma forma diferente
