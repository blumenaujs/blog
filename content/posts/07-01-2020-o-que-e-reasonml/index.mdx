...
que os software sejam entregados com qualidade. Temos diversas formas de aumentar a segurança e código de um software, como testes
...
_cannot read property 'something' of undefined_. Isso infelizmente é uma realidade do desenvolvedor JavaScript. JavaScript é uma linguagem
...
se a linguagem oferecesse isso pra você? E ainda por cima, não te obrigue a anotar os tipos por todo o código como o famigerado ( brinks <3 ) Java ? Reason 
como eu disse anteriormente "herda" de OCaml (na verdade herda de SML) um sistema de tipos poderoso e com uma incrível inferência, onde você
tem os tipos, tem a segurança de uma linguagem fortemente tipada, mas sem precisar sequer ( com algumas execções rs ) escrever os tipos. No decorrer do artigo
