...
Consequentemente ReasonML hearde de OCaml um incrível suporte a programação funcional. Reason pode fazer uso
...
Pra explicar um pouco mais esse código, ignore por hora o _%bs.raw_ e foque em **{| |}** (síntaxe "equivalente" a template strings em JavaScript) que é onde você passa como 
